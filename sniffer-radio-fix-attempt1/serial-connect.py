                    ...
                    if len(word) == 0:
                        ...
                        if len(word) > 0:
                            ...
                            if expectedSeqNr == (ord(word[2]) << 8) + ord(word[3]):
                                ...
                                # TODO: Fix RSSI in received packet
                                # msg[...] = (int8_t(msg[...]) - CC2538_RF_RSSI_OFFSET) with CC2538_RF_RSSI_OFFSET=73

                                receivedCount = (ord(word[4]) << 8) + ord(word[5])
                                print(str(totalCount) + ' ' + str(count) + ' ' + str(receivedCount) + ' ' + str(len(word)))
